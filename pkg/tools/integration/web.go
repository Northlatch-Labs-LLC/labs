...
const (
	...
	userAgentHonest = "labs/%s (+https://github.com/Northlatch-Labs-LLC/labs; AI assistant bot)"
...
func (p *SearXNGSearchProvider) Search(
	...
	// Format results in standard Labs format
...
func (t *WebFetchTool) Execute(ctx context.Context, args map[string]any) *ToolResult {
	...
	// Retry once with an honest User-Agent that identifies labs, which some
