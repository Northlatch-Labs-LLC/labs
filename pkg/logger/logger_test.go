...
func TestConfigureFromEnv(t *testing.T) {
	...
	tmpFile := "/tmp/labs_test_log_" + fmt.Sprintf("%d", time.Now().UnixNano())
	defer os.Remove(tmpFile)

	os.Setenv("LABS_LOG_FILE", tmpFile)
	defer os.Unsetenv("LABS_LOG_FILE")
	...
	os.Setenv("LABS_LOG_FILE", "~/test_log")
	ConfigureFromEnv()
