...
// isLabsProcess uses QueryFullProcessImageNameW to confirm the
// process image name contains "labs". Returns false when the name
...
func isLabsProcess(pid int) bool {
	...
	return strings.Contains(name, "labs")
}
