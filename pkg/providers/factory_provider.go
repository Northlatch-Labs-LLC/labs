...
import (
	...
	anthropicmessages "github.com/Northlatch-Labs-LLC/labs/pkg/providers/anthropic_messages"
	"github.com/Northlatch-Labs-LLC/labs/pkg/providers/azure"
	"github.com/Northlatch-Labs-LLC/labs/pkg/providers/bedrock"
...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: labs auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: labs auth login --provider openai")
	}
