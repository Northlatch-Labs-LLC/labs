...
func TestLoadConfigEventLoggingEnvOverrides(t *testing.T) {
	t.Setenv("LABS_EVENTS_LOGGING_ENABLED", "false")
	t.Setenv("LABS_EVENTS_LOGGING_INCLUDE", "gateway.*,channel.lifecycle.*")
	t.Setenv("LABS_EVENTS_LOGGING_EXCLUDE", "gateway.ready")
	t.Setenv("LABS_EVENTS_LOGGING_MIN_SEVERITY", "error")
	t.Setenv("LABS_EVENTS_LOGGING_INCLUDE_PAYLOAD", "true")
