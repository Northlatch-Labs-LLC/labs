...
//
//	-X github.com/Northlatch-Labs-LLC/labs/pkg/config.Version=<version>
//	-X github.com/Northlatch-Labs-LLC/labs/pkg/config.GitCommit=<commit>
//	-X github.com/Northlatch-Labs-LLC/labs/pkg/config.BuildTime=<timestamp>
//	-X github.com/Northlatch-Labs-LLC/labs/pkg/config.GoVersion=<go-version>
var (
