...
import (
	...
	"github.com/Northlatch-Labs-LLC/labs/pkg/migrate"
)
...
func NewMigrateCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "migrate",
		Short: "Migrate from xxxclaw(openclaw, etc.) to labs",
		Args:  cobra.NoArgs,
		Example: `  labs migrate
  labs migrate --from openclaw
  labs migrate --dry-run
  labs migrate --refresh
  labs migrate --force`,
	...
	cmd.Flags().StringVar(&opts.TargetHome, "target-home", "",
		"Override target home directory (default: ~/.labs)")
