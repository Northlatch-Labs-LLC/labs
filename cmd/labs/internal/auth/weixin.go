...
import (
	...
	"github.com/Northlatch-Labs-LLC/labs/pkg/channels/weixin"
...
to authorize your account. On success, the bot token is saved to the labs
...
func printManualWeixinConfig(token, baseURL string) {
	fmt.Println()
	fmt.Println("Add the following to the channels section of your labs config:")
	fmt.Println()
	fmt.Println(`  "weixin": {`)
