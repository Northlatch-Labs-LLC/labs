...
import (
	...
	"github.com/Northlatch-Labs-LLC/labs/pkg/gateway"
...
func NewGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			return gateway.Run(debug, internal.GetLabsHome(), internal.GetConfigPath(), allowEmpty)
		},
	}
